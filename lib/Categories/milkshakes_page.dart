...
class MilkshakesPage extends StatefulWidget {
  const MilkshakesPage({super.key});

  @override
  State<MilkshakesPage> createState() => _MilkshakesPageState();
}

class _MilkshakesPageState extends State<MilkshakesPage> {
  List<String> burgerImages = [
    "assets/images/shakes.png",
    "assets/images/shakes1.png",
    "assets/images/shakes2.png",
    "assets/images/shakes3.png",
  ];
